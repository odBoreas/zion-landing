    ...
    >
      ...
      <div className="relative z-10 flex max-w-5xl flex-col items-center gap-8">
        ...
        <AnimatedReveal delay={0.15}>
          <h1
            id="hero-heading"
            className="glitch text-display noise-clip-text"
            data-text={h.dataText}
          >
            {h.line1}
            <br />
            <span style={{ WebkitTextFillColor: '#00E5FF', color: '#00E5FF' }}>{h.line2}</span>
            <br />
            {h.line3}
          </h1>
        </AnimatedReveal>
        ...
        <AnimatedReveal delay={0.25}>
          <p className="max-w-md text-base leading-relaxed text-text-primary" style={{ letterSpacing: '-0.01em' }}>
            {h.sub}{' '}
            <span className="text-accent">{h.subAccent}</span>
          </p>
        </AnimatedReveal>
